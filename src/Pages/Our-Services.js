...
export const OurServices = () => {
  return (
    <div className="fs-1  flex services fw-bold" id="services">
      <br />
      <br />

      <marquee behavior="scroll" direction="">
        <h1 className="service-title">OUR SERVICES OUR SERVICES</h1>
      </marquee>
      <br />

      <Row className="main_box">
        <Col className="mid_box" xs={12} sm={6} md={3}>
          <div className="img_box">
            <img
              src={imagthumb1}
              className="img-thumbnail service-image"
              alt="..."
            />
          </div>
          <br />
        ...
        <Col className="mid_box" xs={12} sm={6} md={3}>
          <div className="img_box">
            <img
              src={imagthumb4}
              className="img-thumbnail fw-lighter"
              alt="..."
            />
          </div>
          <br />
